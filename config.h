...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_grave,	spawn,	{.v = (const char*[]){ "dmenuemoticons", NULL } } },
	TAGKEYS(			XK_1,		0)
	TAGKEYS(			XK_2,		1)
	TAGKEYS(			XK_3,		2)
	TAGKEYS(			XK_4,		3)
	...
	{ MODKEY|ShiftMask,		XK_s,		togglestickybg,	{0} },
	...
	{ MODKEY,			XK_c,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "nmtui", NULL } } },
	...
	{ MODKEY,			XK_F5,		spawn,		{.v = (const char*[]){ "displayselect", NULL } } },
